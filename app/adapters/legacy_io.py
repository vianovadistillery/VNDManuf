...
class FixedWidthParser:
    ...
    def _parse_field(
        self, field_data: bytes, field_type: str, field_spec: Dict[str, Any]
    ) -> Any:
        ...
        with data_file.open("rb") as f:
            while True:
                ...
                try:
                    ...
                    print(
                        f"Error parsing record at position {f.tell() - record_length}: {e}"
                    )
                    continue
...
class LegacyDataMapper:
    ...
    def map_record(
        self, legacy_record: Dict[str, Any], target_table: str
    ) -> Dict[str, Any]:
