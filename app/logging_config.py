...
class StructuredLogger:
    ...
    def warning(
        ...
        **kwargs,
        ...
        """Log warning message."""
        self._log(
            logging.WARNING, message, request_id, user_id, entity, entity_id, kwargs
        )
    ...
    def error(
        ...
        **kwargs,
        ...
        """Log error message."""
        self._log(
            logging.ERROR, message, request_id, user_id, entity, entity_id, kwargs
        )
    ...
    def debug(
        ...
        **kwargs,
        ...
        """Log debug message."""
        self._log(
            logging.DEBUG, message, request_id, user_id, entity, entity_id, kwargs
        )
