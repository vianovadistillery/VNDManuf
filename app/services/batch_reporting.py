    ...
    def get_batch_data(self, batch_code: str) -> Optional[Dict[str, Any]]:
        ...
        stmt = (
            ...
            .options(
                ...
                joinedload(Batch.components).joinedload(
                    BatchComponent.ingredient_product
                ),
...
def get_batch_data_for_reporting(
    batch_code: str, db: Session
...
def get_batch_summary_for_reporting(
    batch_code: str, db: Session
) -> Optional[Dict[str, Any]]:
