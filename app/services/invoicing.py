...
from app.adapters.db.models import Customer, Invoice, InvoiceLine, SoLine
...
class InvoicingService:
    ...
    def get_customer_invoices(
        self, customer_code: str, limit: int = 100
    ) -> List[Dict[str, Any]]:
        ...
        stmt = (
            ...
            .options(joinedload(Invoice.customer), joinedload(Invoice.lines))
...
def get_invoice_data_for_reporting(
    invoice_number: str, db: Session
...
def get_invoice_summary_for_reporting(
    invoice_number: str, db: Session
) -> Optional[Dict[str, Any]]:
...
def get_customer_invoices_for_reporting(
    customer_code: str, db: Session, limit: int = 100
) -> List[Dict[str, Any]]:
