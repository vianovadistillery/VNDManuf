...
class ShopifySyncService:
    ...
    def push_inventory(self, product_id: str) -> Dict[str, Any]:
        ...
        """
        # Get channel link
        link = self.db.query(ProductChannelLink).filter_by(
    ...
    def apply_shopify_fulfillment(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for reservation in reservations:
            try:
                ...
                self.db.rollback()
                return {"ok": False, "error": f"Failed to commit reservation {reservation.id}: {str(e)}"}
    ...
    def apply_shopify_cancel(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for reservation in reservations:
            try:
                ...
                return {"ok": False, "error": f"Failed to release reservation {reservation.id}: {str(e)}"}
