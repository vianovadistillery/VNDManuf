    ...
    def get_layout():
        return dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        dbc.Row([
                            dbc.Col([
                                dbc.Button("Refresh", id="products-refresh", color="primary", className="me-2"),
                                dbc.Button("Export CSV", id="products-export-csv", color="info", className="me-2"),
                                dbc.Button("Add Product", id="add-product", color="success")
                            ])
                        ], className="mb-3"),
            ...
            dbc.Modal([
                ...
                dbc.ModalFooter([
                    dbc.Button("Submit", id="product-submit", color="primary", className="me-2"),
                    dbc.Button("Cancel", id="product-cancel", color="secondary")
                ])
            ], id="product-form", is_open=False)
        ], fluid=True)
    ...
    def get_layout():
        return dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        dbc.Button("Refresh", id="batches-refresh", color="primary", className="mb-3"),
                        dash_table.DataTable(
                            id="batches-table",
                            columns=[],
                            data=[],
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        dbc.Button("Print Selected Batch", id="batch-print-btn", color="primary", className="mb-3"),
        ...
        return dbc.Container([
            dbc.Row([
                dbc.Col([
                    ...
                    dbc.Button("Refresh", id="inventory-refresh", color="primary", className="mb-3"),
                    dash_table.DataTable(
                        id="inventory-table",
                        columns=[],
                        data=[],
    ...
    def get_layout():
        return dbc.Container([
            dbc.Row([
                dbc.Col([
                    html.H4("Price Lists"),
                    dbc.Button("Refresh", id="pricing-refresh", color="primary", className="mb-3"),
                    dash_table.DataTable(
                        id="pricing-table",
                        columns=[],
                        data=[],
        ...
        return dbc.Container([
                ...
                dbc.Col([
                    dbc.Tabs(
                        ...
                        children=[
                            ...
                            dbc.Tab(label="Unit Conversion", tab_id="convert"),
                        ],
                        className="mb-4"
                    )
                ])
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        html.H4("Pack Units"),
                        dbc.Button("Refresh", id="packaging-refresh", color="primary", className="mb-3"),
                        dash_table.DataTable(
                            id="packaging-table",
                            columns=[],
                            data=[],
                            ...
                            dbc.Form([
                                dbc.Row([
                                    dbc.Col([
                                        ...
                                        dbc.Input(id="pack-product-id", placeholder="Enter product ID")
                                    ], width=6),
                                    dbc.Col([
                                        dbc.Label("Quantity"),
                                        dbc.Input(id="pack-quantity", type="number", step="0.001", placeholder="0.000")
                                    ], width=6)
                                ], className="mb-3"),
                                ...
                                dbc.Row([
                                    dbc.Col([
                                        dbc.Button("Convert", id="pack-convert-btn", color="primary")
                                    ])
                                ])
                            ])
                        ])
            ...
            ], id="packaging-convert-content", style={"display": "none"})
        ], fluid=True)
    ...
    def get_layout():
        return dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        dbc.Button("Refresh", id="invoices-refresh", color="primary", className="mb-3"),
                        dash_table.DataTable(
                            id="invoices-table",
                            columns=[],
                            data=[],
            ...
            dbc.Row([
                dbc.Col([
                    html.Div([
                        dbc.Button("Print Selected Invoice", id="invoice-print-btn", color="primary", className="mb-3"),
