...
class RawMaterialsPage:
    ...
    def get_layout():
        return dbc.Container(
            [
                # Header
                dbc.Row([dbc.Col([html.H2("Raw Materials", className="mb-4")])]),
                # Filters
                dbc.Row(
                    [
                        dbc.Col(
                            ...
                            [
                                dbc.ButtonGroup(
                                    [
                                        ...
                                        dbc.Button(
                                            "Edit", id="rm-edit-btn", color="primary"
                                        ),
                                        dbc.Button(
                                            "Delete", id="rm-delete-btn", color="danger"
                                        ),
                                        dbc.Button(
                                            "🔄 Refresh",
                                            id="rm-refresh-btn",
