...
def register_suppliers_callbacks(app, make_api_request):
    ...
    def load_suppliers(n_clicks_search, n_clicks_clear, n_clicks_refresh, active_tab, search_text, active_filter):
        ...
        try:
            ...
            if not ctx.triggered:
                ...
                if triggered_id in ["suppliers-clear-btn.n_clicks", "suppliers-refresh-btn.n_clicks", "main-tabs.active_tab"]:
                    params = {}
                else:
                    ...
                    if active_filter and isinstance(active_filter, list) and "active" in active_filter:
    ...
    @app.callback(
        ...
        [State("suppliers-table", "selected_rows"),
    ...
    def open_suppliers_modal(add_clicks, edit_clicks, selected_rows, data):
        ...
        if button_id == "suppliers-add-btn":
            # Add mode - clear form
            return [True, "Add Supplier", None, None, None, None, None, None, None, True]
    ...
    def save_supplier(n_clicks, code, name, contact, email, phone, address, xero_id, is_active, title, supplier_id):
        ...
        try:
            ...
            success_msg = f"Supplier {name} {'updated' if is_edit else 'created'} successfully"
    ...
    def toggle_delete_supplier_modal(delete_clicks, confirm_clicks, cancel_clicks, selected_rows, data):
        ctx = dash.callback_context
        if not ctx.triggered:
            return "", False
    ...
    def delete_supplier(n_clicks, selected_rows, data):
        ...
        try:
            response = make_api_request("DELETE", f"/suppliers/{supplier_id}")
            ...
            return new_data, True, "Success", f"Supplier {supplier_name} deleted successfully"
