"""Add billing/delivery address, ABN and notes to contacts.

Revision ID: 20250223_contacts_addr
Revises: 20250223_cust_addr
...
revision: str = "20250223_contacts_addr"
down_revision: Union[str, None] = "20250223_cust_addr"
    ...
    if bind.dialect.name == "sqlite":
        with op.batch_alter_table("contacts", schema=None) as batch_op:
            for name, col_type in cols:
                if not _has_column(insp, "contacts", name):
