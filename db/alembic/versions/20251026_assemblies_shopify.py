...
def upgrade():
    ...
    op.create_index(
        "ix_product_channel_links_product", "product_channel_links", ["product_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column("product_id", sa.String(36), nullable=False),
        sa.Column(
            "qty_canonical", sa.Numeric(18, 6), nullable=False
    ...
    op.create_index(
        "ix_inventory_reservations_product", "inventory_reservations", ["product_id"]
    )


def downgrade():
    op.drop_index(
        "ix_inventory_reservations_product", table_name="inventory_reservations"
    )
    op.drop_table("inventory_reservations")

    op.drop_index(
        "ix_product_channel_links_product", table_name="product_channel_links"
    )
