...
def upgrade() -> None:
    ...
    op.add_column('batches', sa.Column('yield_actual', sa.Numeric(12, 3), nullable=True))
    op.add_column('batches', sa.Column('yield_litres', sa.Numeric(12, 3), nullable=True))
    op.add_column('batches', sa.Column('variance_percent', sa.Numeric(5, 2), nullable=True))
