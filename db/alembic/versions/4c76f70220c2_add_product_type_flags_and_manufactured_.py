...
def upgrade() -> None:
    ...
    op.add_column('products', sa.Column('manufactured_cost_inc_gst', sa.Numeric(precision=10, scale=2), nullable=True))
    op.add_column('products', sa.Column('manufactured_cost_ex_gst', sa.Numeric(precision=10, scale=2), nullable=True))
    op.add_column('products', sa.Column('manufactured_tax_included', sa.String(length=1), nullable=True))
