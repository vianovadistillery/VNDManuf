...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["raw_material_id"],
            ["raw_materials.id"],
            name=op.f("fk_raw_material_suppliers__raw_material_id__raw_materials"),
        ),
        sa.ForeignKeyConstraint(
            ["supplier_id"],
            ["suppliers.id"],
            name=op.f("fk_raw_material_suppliers__supplier_id__suppliers"),
        ),
    ...
    op.create_index(
        "ix_rm_supplier_material",
        "raw_material_suppliers",
        ["raw_material_id"],
        unique=False,
    )
    op.create_index(
        "ix_rm_supplier_supplier",
        "raw_material_suppliers",
        ["supplier_id"],
        unique=False,
    )
