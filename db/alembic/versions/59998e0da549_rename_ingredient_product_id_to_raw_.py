    ...
    try:
        ...
        if 'ingredient_product_id' in columns:
            ...
            with op.batch_alter_table('formula_lines', schema=None) as batch_op:
                batch_op.alter_column('ingredient_product_id', new_column_name='raw_material_id')
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('formula_lines', schema=None) as batch_op:
        batch_op.alter_column('raw_material_id', new_column_name='ingredient_product_id')
