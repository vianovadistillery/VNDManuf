...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "unit_price_ex_tax", sa.Numeric(precision=10, scale=2), nullable=False
        ),
        sa.Column("effective_date", sa.DateTime(), nullable=False),
        sa.Column("expiry_date", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "conversion_factor", sa.Numeric(precision=12, scale=6), nullable=False
        ),
        sa.Column("is_active", sa.Boolean(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "product_id", "variant_code", name="uq_product_variant_code"
        ),
    )
    op.create_table(
        "purchase_orders",
    ...
    op.create_index(
        op.f("ix_sales_orders_so_number"), "sales_orders", ["so_number"], unique=True
    )
    op.create_table(
        "formula_lines",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        "ix_txn_lot_ts", "inventory_txns", ["lot_id", "created_at"], unique=False
    )
    op.create_table(
        "invoices",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "line_total_ex_tax", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        sa.Column(
            "line_total_inc_tax", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        sa.Column("sequence", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["product_id"],
    ...
    op.create_index(
        "ix_batch_wo_code", "batches", ["work_order_id", "batch_code"], unique=False
    )
    op.create_table(
        "invoice_lines",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("ingredient_product_id", sa.String(length=36), nullable=False),
        sa.Column(
            "required_quantity_kg", sa.Numeric(precision=12, scale=3), nullable=False
        ),
        sa.Column(
            "allocated_quantity_kg", sa.Numeric(precision=12, scale=3), nullable=True
        ),
        sa.Column("sequence", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["ingredient_product_id"],
