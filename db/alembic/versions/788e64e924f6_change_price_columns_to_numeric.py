...
def upgrade() -> None:
    ...
    if is_sqlite:
        ...
        op.add_column(
            "products", sa.Column("wholesalecde_new", sa.Numeric(10, 2), nullable=True)
        )
        op.add_column(
            "products", sa.Column("retailcde_new", sa.Numeric(10, 2), nullable=True)
        )
        op.add_column(
            "products", sa.Column("countercde_new", sa.Numeric(10, 2), nullable=True)
        )
        op.add_column(
            "products", sa.Column("tradecde_new", sa.Numeric(10, 2), nullable=True)
        )
        op.add_column(
            "products", sa.Column("contractcde_new", sa.Numeric(10, 2), nullable=True)
        )
        op.add_column(
            "products", sa.Column("industrialcde_new", sa.Numeric(10, 2), nullable=True)
        )
        op.add_column(
            "products",
            sa.Column("distributorcde_new", sa.Numeric(10, 2), nullable=True),
        )
        ...
        op.alter_column(
            "products", "industrialcde_new", new_column_name="industrialcde"
        )
        op.alter_column(
            "products", "distributorcde_new", new_column_name="distributorcde"
        )
    else:
...
def downgrade() -> None:
    ...
    if is_sqlite:
        # SQLite workaround
        op.add_column(
            "products", sa.Column("wholesalecde_old", sa.String(1), nullable=True)
        )
        op.add_column(
            "products", sa.Column("retailcde_old", sa.String(1), nullable=True)
        )
        op.add_column(
            "products", sa.Column("countercde_old", sa.String(1), nullable=True)
        )
        op.add_column(
            "products", sa.Column("tradecde_old", sa.String(1), nullable=True)
        )
        op.add_column(
            "products", sa.Column("contractcde_old", sa.String(1), nullable=True)
        )
        op.add_column(
            "products", sa.Column("industrialcde_old", sa.String(1), nullable=True)
        )
        op.add_column(
            "products", sa.Column("distributorcde_old", sa.String(1), nullable=True)
        )
        ...
        op.alter_column(
            "products", "industrialcde_old", new_column_name="industrialcde"
        )
        op.alter_column(
            "products", "distributorcde_old", new_column_name="distributorcde"
        )
    else:
        # PostgreSQL
        op.alter_column(
        ...
        op.alter_column(
            "products", "retailcde", type_=sa.String(1), existing_type=sa.Numeric(10, 2)
        )
        op.alter_column(
            "products",
            "countercde",
        ...
        op.alter_column(
            "products", "tradecde", type_=sa.String(1), existing_type=sa.Numeric(10, 2)
        )
        op.alter_column(
            "products",
            "contractcde",
