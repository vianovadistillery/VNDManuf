...
def upgrade() -> None:
    ...
    op.add_column(
        "products",
        sa.Column("purchase_tax_included", sa.String(length=1), nullable=True),
    )
    ...
    op.add_column(
        "products",
        sa.Column(
            "usage_cost_inc_gst", sa.Numeric(precision=10, scale=2), nullable=True
        ),
    )
    op.add_column(
        "products",
        sa.Column(
            "usage_cost_ex_gst", sa.Numeric(precision=10, scale=2), nullable=True
        ),
    )
    op.add_column(
        "products", sa.Column("usage_tax_included", sa.String(length=1), nullable=True)
    )
