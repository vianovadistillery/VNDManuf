...
def test_list_products_no_filter():
    ...
    try:
        ...
        for product in products:
            ...
            assert product["product_type"] in ["RAW", "WIP", "FINISHED"], \
                f"Invalid product_type: {product['product_type']}"
        print(f"   [OK] All products have valid product_type field")
        return products
...
def test_list_products_filter_raw():
    ...
    try:
        ...
        print(f"   [OK] All products are RAW type")
        return products
    except AssertionError as e:
        print(f"   [FAIL] {e}")
        return []
...
def test_list_products_filter_wip():
    ...
    try:
        ...
        print(f"   [OK] All products are WIP type")
        return products
    except AssertionError as e:
        print(f"   [FAIL] {e}")
        return []
...
def test_list_products_filter_finished():
    ...
    try:
        response = requests.get(f"{API_BASE_URL}/products?product_type=FINISHED", timeout=5)
        assert response.status_code == 200, f"Expected 200, got {response.status_code}"
        products = response.json()
        assert isinstance(products, list), "Response should be a list"
        print(f"   [OK] Retrieved {len(products)} products")
        ...
        print(f"   [OK] All products are FINISHED type")
        return products
    except AssertionError as e:
        print(f"   [FAIL] {e}")
        return []
...
def test_invalid_product_type():
    ...
    try:
        ...
        print(f"   [OK] Correctly rejected invalid product_type")
        return True
    except AssertionError as e:
        print(f"   [FAIL] {e}")
        return False
