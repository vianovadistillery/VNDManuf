...
def test_assembly_operations():
    ...
    try:
        ...
        print(f"   [OK] Created assembly: WIP from RAW1 (0.6:1 ratio)")
        print(f"   [OK] Created assembly: WIP from RAW2 (0.4:1 ratio)")
        print(f"   [OK] Created assembly: FINISHED from WIP (1.0:1 ratio)")
