...
class TestRounding:
    ...
    def test_round_quantity_default(self):
        ...
        assert round_quantity(Decimal("1.23454")) == Decimal("1.235")  # Bankers' rounding
        assert round_quantity(Decimal("1.23450")) == Decimal("1.234")  # Bankers' rounding
...
class TestFifoIssue:
    ...
    def create_test_lot(self, lot_id: str, quantity: Decimal, unit_cost: Decimal = None):
