...
from app.adapters.db.models import Formula, FormulaLine, InventoryLot, Product
...
def test_product_types(db_session: Session):
    ...
    wip = Product(
        sku="WIP-001", name="Work In Progress", product_type="WIP", base_unit="KG"
    )
...
def test_formula_line_with_unified_products(db_session: Session):
    ...
    finished = Product(
        sku="FG-101", name="Finished Product", product_type="FINISHED", base_unit="KG"
    )
...
def test_inventory_lot_unified_products(db_session: Session):
    ...
    finished = Product(
        sku="FG-201", name="Finished", product_type="FINISHED", base_unit="KG"
    )
